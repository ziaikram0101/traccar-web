...
import MapPinEdit from '../map/MapPinEdit';
      ...
      <div className={classes.content}>
        ...
        >
          <Toolbar>
            ...
            <Typography variant="h6" className={classes.title}>Pins</Typography>
          ...
          <Divider />
          <PinsList onGeofenceSelected={setSelectedGeofenceId} />
        </Drawer>
        <div className={classes.mapContainer}>
          <MapView>
            <MapPinEdit selectedGeofenceId={selectedGeofenceId} />
            <MapDefaultCamera />
          </MapView>
          <MapCurrentLocation />
          <MapGeocoder />
